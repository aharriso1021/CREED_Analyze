function this_gaze_data  = CREED_GazeData2(data, blink_parameters, prm)
 
this_gaze_data.TrialTime = [1:1:length(data.Gaze_X)]/1000;
this_gaze_data.TrialEventsLabels = deblank(data.EVENTS.LABELS);
...
%% Adding Pupil Data
this_gaze_data.Gaze_PupilArea = data.Gaze_PupilArea;

%% Adding Blink Parameters
this_gaze_data.blink_parameters = blink_parameters;
